...
export type AnalyticsEventName =
  ...
  | "investment_created"
  | "investment_updated"
  | "investment_statement_uploaded"
  | "investment_statement_import_confirmed"
  | "bank_account_created_from_investments"
  | "cnis_statement_uploaded"
  | "cnis_import_confirmed"
  | "cnis_history_cleared"
